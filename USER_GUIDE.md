# 📖 คู่มือการใช้งาน GOODGUY TCG Store
...
```bash
# Database
DATABASE_URL=postgresql://goodguy:password@localhost:5433/goodguytcg
...
```bash
# Build image
docker build -t goodguytcg .

# Run
docker run -p 3000:3000 --env-file .env goodguytcg
```
...
> 📝 เอกสารนี้สร้างสำหรับ GOODGUY TCG Store v0.1.0
> สอบถามเพิ่มเติม: LINE @goodguytcg
